      ...
      JOIN (
        ...
        -- End Measurement Criteria
            ...
            (
              ...
              from
              (
                	  select row_number()over() as procedure_occurrence_id, po.oncoemr_person_id as person_id,  row_number()over() as visit_occurrence_id, po.*
                FROM study_reference.openclaims_pc_procedures po
