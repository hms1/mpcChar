...
(
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (40222431,1309188,35603551,43526934,40224095,45763838)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (40222431,1309188,35603551,43526934,40224095,45763838)
  and c.invalid_reason is null
...
TRUNCATE TABLE #Measurement_criteria;
DROP TABLE #Measurement_criteria;
